...
public class UserController {
	...
	public String forwardToUserDetail( @PathVariable String userId,
		...
		model.addAttribute(CommonCode.PAGE_TYPE.READ,true);
		model.addAttribute(CommonCode.PAGE_TYPE.UPDATE,true);
		model.addAttribute(CommonCode.PAGE_TYPE.DELETE,true);
		model.addAttribute(CommonCode.PAGE_TYPE.CREATE,false);
	...
	public String forwardToUserAdd(final ModelMap model) {
		...
		model.addAttribute(CommonCode.PAGE_TYPE.UPDATE,false);
		model.addAttribute(CommonCode.PAGE_TYPE.CREATE,true);
		return "hakstrace/system/user/user_detail";
	}
	...
	public Map<String,Boolean> checkExistUser(@RequestParam(value = "userId", required = true) String userId) {
		...
		map.put("valid", userService.findByUserId(userId) == null);
		return map;
	}
